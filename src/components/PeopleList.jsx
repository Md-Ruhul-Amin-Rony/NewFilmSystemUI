...
//     fetch('https://localhost:7146/Person/GetAllPeople')
...
//   useEffect(() => {
//     // Fetch data from the API endpoint
//     fetch('https://localhost:7146/Person/GetAllPeopleDetails')
//       .then((response) => response.json())
//       .then((data) => {
//         // Update the state with the fetched data
//         setPeople(data);
...
//                 <li key={`${selectedPerson.PersonId}-${movie.id}`}>{movie.link}</li>
//               ))}
//             </ul>
//           </div>
//         )}
